...
const PrivacyPolicyQuill = () => {
  ...
  return (
    <div style={{ padding: "16px 0px",marginTop:"5px" }}>
      {/* Header Card */}
      <Card
      ...
      >
        ...
        <Text type="secondary">
            Manage all the platform policy in your system
        </Text>
      </Card>

      {/* Editor Section */}
      <Card style={{ borderRadius: 8 }} bodyStyle={{ padding: 16 }} className="card-cs">
...
export default PrivacyPolicyQuill;
