...
const EditSubscription = ({
  ...
  const [updateSubscriptionPlan, { loading, error }] = useMutation(
    UPDATE_SUBSCRIPTION_PLAN,
    {
      onCompleted: () => {
        notifySuccess(
          api,
          t("Subscription Plan Update"),
          t("Subscription Plan has been updated successfully"),
        );
        getSubscriptionPlans();
        setTimeout(() => {
          setEditItem(null);
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      await updateSubscriptionPlan({
        variables: { input: { ...data, id: edititem?.id } },
      });
    } catch (e) {
      console.log(e);
    }
          ...
          <Col span={24}>
            <IncludeFeatureField
              ...
              fields={[
                ...
                {
                  key: "promotions",
                  selectOptions: [{ label: "Promotions", value: "promotion" }],
                },
                {
                  key: "selfServiceTablet",
                  selectOptions: [
                    {
                      label: "Self Service Tablet",
              ...
              onSwitchChange={(checked, key) =>
                console.log("Switch:", key, checked)
              }
            />
          </Col>
          <Col span={24}>
