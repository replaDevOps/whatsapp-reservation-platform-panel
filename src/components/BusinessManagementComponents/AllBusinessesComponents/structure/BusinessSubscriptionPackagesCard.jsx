...
const BusinessSubscriptionPackagesCard = ({
  subscriptionPlans,
              ...
              <Col span={24} key={plan.id}>
                <Card
                  ...
                  className={`border-gray bg-transparent card-cs ${
                    plan?.type === selectedSubscriptionPlan?.type
                      ? "active-radio"
                      : ""
                  }`}
                        ...
                        <Flex vertical gap={0}>
                          ...
                          <Paragraph
                            ...
                            ellipsis={{
                              ...
                              symbol: expanded ? (
                                <Text className="text-brand">less</Text>
                              ) : (
                                <Text className="text-brand">more</Text>
                              ),
                    ...
                    <Col span={24} md={12} lg={10} xl={8}>
                      <Title level={4} className="m-0">
                        <Flex justify="end" gap={4} wrap>
                          <sup className="fs-12 fw-600 text-grey">
                            {t("SAR")}
                          </sup>
                          ...
                          <span className="fs-12 fw-500 text-gray">
                            /{t(capitalizeTranslated(subscriptionValidity))}
                          </span>
                        </Flex>
                      </Title>
                    </Col>
