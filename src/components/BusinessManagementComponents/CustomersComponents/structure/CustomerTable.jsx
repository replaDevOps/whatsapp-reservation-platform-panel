...
const CustomerTable = () => {
  ...
  const [getSubscriberCustomers, { data, loading }] = useLazyQuery(
  ...
  useEffect(() => {
    if (getSubscriberCustomers) fetchCustomer();
  }, [
      ...
      <Card className="radius-12 card-cs border-gray h-100">
          ...
          <Flex justify="space-between" align="center" gap={10}>
            <Flex vertical>
              ...
              <Text className="text-gray fs-13">
                {t("Manage all the Customers in your system")}
              </Text>
            </Flex>
            <Button
              className="btncancel"
        ...
        <Flex vertical gap={20}>
          <Table
            ...
            className={
              i18n?.language === "ar"
                ? "pagination table-cs table right-to-left w-100"
                : "w-100 pagination table-cs table left-to-right"
            }
